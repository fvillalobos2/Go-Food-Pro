...
function cartInit() {
  ...
  if (data) {
    ...
    if(total != 0){
      ...
      <a class="btn btn-success" href="https://api.whatsapp.com/send?phone=50688906767?text=Hola me gustaria ordenar el siguiente carrito:%0D%0A${name} %0D%0ATotal:&#8353;${total}" target="_blank">Comprar via Whatsapp</a>
      `;
